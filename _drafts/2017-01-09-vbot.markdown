...
So this is the basic demo on how to use vbot to do VRT. There are other features it supports, such as preset localStorage values, set maximum timeout for assert an element to appear, scroll page, etc. For more details about vbot, please go to its [github repo](https://github.com/katat/vbot).
